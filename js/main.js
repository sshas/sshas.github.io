...
class Device {
  ...
  get id() {
    return mapStore$1.get(this).device.id;
  }
  ...
  get name() {
    return mapStore$1.get(this).device.name;
  }

  get roomId() {
    return mapStore$1.get(this).room.id;
  }

  get type() {
    return mapStore$1.get(this).device.type;
  }
 ...
 */
const mapStore$3 = new WeakMap();

class Device$1 {

  constructor(modelDevice) {
    mapStore$3.set(this, { model: modelDevice });
  }

  get model() {
    return mapStore$3.get(this).model;
  }
 ...
 * Created by steve on 13/10/2016.
 */
const mapStore$2 = new WeakMap();

class Room$1 {

  constructor(modelRoom) {
    mapStore$2.set(this, { model: modelRoom });
  }

  get model() {
    return mapStore$2.get(this).model;
  }
  ...
  render() {
    ...
    this.devices = this.model.devices.map((device) => {
      const view = new Device$1(device);
